...
export interface TablePickSenderItem {
   id: number;
   firstName: string;
   lastName: string;
   phone: string;
...
const EXAMPLE_DATA: TablePickSenderItem[] = [
 ...
 */
export class TablePickSenderDataSource extends DataSource<TablePickSenderItem> {
  data: TablePickSenderItem[] = EXAMPLE_DATA;
   ...
   */
  connect(): Observable<TablePickSenderItem[]> {
   ...
   */
  private getPagedData(data: TablePickSenderItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: TablePickSenderItem[]) {
